...
cor(cov_values)
# slope, terrain roughness, and TRI
...
# standardise guano raster (mean of 0 sd of 1)
...
Guano_model2 <- lgcp(Guano_cmp2, # formula
                   data = sf_Crozier, # locations
                   samplers = sf_Crozier_UAV_area, # sample area of UAV bounds
                   domain = list(geometry = Crozier_mesh), # mesh
                   options = list(
