...
- `03_Inlabru_diagnostics.R`: This script contains the R code to calculated the expected abundances, residuals, and diagnostic statistics for the 8 2020 candidate models.
...
- `06_Inlabru_testing.R`: This script contains the R code to use 2019 trained candidate models to predict abundance for 2020.
