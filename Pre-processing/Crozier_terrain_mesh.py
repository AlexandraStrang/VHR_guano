# Crozier mesh: python script for calculating terrain variables from REMA DEMs
...
OUTPUT_DIR = r'D:\Terrain\Crozier_terrain_mesh'
MESH_DIR = r'D:\Terrain\Crozier_mesh'
...
class DemMetrics:
    ...
    def _clip_dem_to_aoi(self):
        ...
        with fiona.open(mesh_path, "r") as shapefile:
